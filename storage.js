...
if(typeof emailjs !== 'undefined') emailjs.init({ publicKey: EMAILJS_PUBLIC_KEY }); // admin.html doesn't load the EmailJS SDK (not needed there)
...
function sendOtpEmail(toEmail, toName, code){
  if(typeof emailjs === 'undefined') return Promise.reject(new Error('EmailJS not loaded on this page'));
